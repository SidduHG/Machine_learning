...
### Current release scope (owner revision)

The owner requested a focused, substantial classical-ML course and a minimal textbook-style design. The released scope is 30 chapters in six modules, seven visual labs, 30 standard-library calculations, 13 complete scikit-learn examples, four classical-ML project notebooks and a 30-question intermediate/advanced assessment. Deep learning and modern-AI material is preserved in `lib/deferred` for later work and is not published or counted. This revision supersedes the original broad content scope below while retaining the six-PR delivery sequence.

Each chapter follows theory, mathematical explanation, worked example, runnable code, visualization, case study, exercises and guided sources. See [the revision spec](release-quality/course-quality-revision.md).
