...
pipeline = make_pipeline(StandardScaler(), RandomForestClassifier(n_estimators=120, min_samples_leaf=2, random_state=42))
...
for label, model in [('Baseline', baseline), ('Random forest', pipeline)]:
