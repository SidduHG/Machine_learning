...
pipeline = make_pipeline(StandardScaler(), DecisionTreeClassifier(max_depth=3, min_samples_leaf=3, random_state=42))
...
for label, model in [('Baseline', baseline), ('Decision tree', pipeline)]:
